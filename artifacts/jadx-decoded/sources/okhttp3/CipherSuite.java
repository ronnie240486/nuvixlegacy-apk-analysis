...
public final class CipherSuite {
    ...
    public static final class Companion {
        ...
        public final synchronized CipherSuite forJavaName(String str) {
            ...
            try {
                AbstractC0919e.m2108f(str, "javaName");
    ...
    static {
        ...
        ORDER_BY_NAME = new Comparator<String>() { // from class: okhttp3.CipherSuite$Companion$ORDER_BY_NAME$1
            ...
            public int compare(String str, String str2) {
                AbstractC0919e.m2108f(str, "a");
                AbstractC0919e.m2108f(str2, "b");
                int iMin = Math.min(str.length(), str2.length());
                for (int i5 = 4; i5 < iMin; i5++) {
                    char cCharAt = str.charAt(i5);
                    char cCharAt2 = str2.charAt(i5);
                    if (cCharAt != cCharAt2) {
                        return AbstractC0919e.m2110h(cCharAt, cCharAt2) < 0 ? -1 : 1;
                    }
                }
    ...
    public /* synthetic */ CipherSuite(String str, AbstractC0917c abstractC0917c) {
        this(str);
    }
    ...
    public final String m7393deprecated_javaName() {
