...
public final class RealCall implements Call {
    ...
    public final class AsyncCall implements Runnable {
        ...
        public AsyncCall(RealCall realCall, Callback callback) {
            AbstractC0919e.m2108f(callback, "responseCallback");
        ...
        public final void reuseCallsPerHostFrom(AsyncCall asyncCall) {
            AbstractC0919e.m2108f(asyncCall, "other");
                    ...
                    try {
                        try {
                            ...
                            if (!z5) {
                                ...
                                AbstractC1119a.m2463a(iOException, th);
    ...
    public static final class CallReference extends WeakReference<RealCall> {
        ...
        public CallReference(RealCall realCall, Object obj) {
            super(realCall);
            AbstractC0919e.m2108f(realCall, "referent");
    ...
    /* JADX WARN: Type inference failed for: r4v5, types: [f5.I, okhttp3.internal.connection.RealCall$timeout$1] */
    public RealCall(OkHttpClient okHttpClient, Request request, boolean z5) {
        ...
        ?? r5 = new C2380g() { // from class: okhttp3.internal.connection.RealCall.timeout.1
    ...
    public final Response getResponseWithInterceptorChain$okhttp() {
        ...
        AbstractC0335q.m1068V(arrayList, this.client.interceptors());
        ...
        if (!this.forWebSocket) {
            AbstractC0335q.m1068V(arrayList, this.client.networkInterceptors());
        }
        ...
        try {
            try {
                ...
                AbstractC0919e.m2106d(iOExceptionNoMoreExchanges$okhttp, "null cannot be cast to non-null type kotlin.Throwable");
    ...
    public final Exchange initExchange$okhttp(RealInterceptorChain realInterceptorChain) throws IOException {
        ...
        AbstractC0919e.m2105c(exchangeFinder);
    ...
    public final Socket releaseConnectionNoEvents$okhttp() {
        ...
        while (true) {
            ...
            if (AbstractC0919e.m2103a(it.next().get(), this)) {
                break;
            }
            i5++;
        }
