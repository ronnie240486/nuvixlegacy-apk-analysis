...
public final class ExchangeFinder {
    ...
    private final RealConnection findConnection(int i5, int i6, int i7, int i8, boolean z5) throws IOException {
        List<Route> routes;
        ...
        if (this.connectionPool.callAcquirePooledConnection(this.address, this.call, null, false)) {
            ...
            AbstractC0919e.m2105c(connection2);
        ...
        try {
            if (next == null) {
                ...
                if (selection != null) {
                    AbstractC0919e.m2105c(selection);
                    if (selection.hasNext()) {
                        RouteSelector.Selection selection2 = this.routeSelection;
                        AbstractC0919e.m2105c(selection2);
                    ...
                    realConnection.connect(i5, i6, i7, i8, z5, this.call, this.eventListener);
                    ...
                    AbstractC0919e.m2105c(connection3);
                ...
                if (this.connectionPool.callAcquirePooledConnection(this.address, this.call, routes, false)) {
                    ...
                    AbstractC0919e.m2105c(connection4);
                ...
                AbstractC0919e.m2105c(connection5);
                this.nextRouteToTry = next;
                Util.closeQuietly(realConnection.socket());
                this.eventListener.connectionAcquired(this.call, connection5);
                return connection5;
            }
            AbstractC0919e.m2105c(next);
            ...
            AbstractC0919e.m2105c(connection6);
            this.nextRouteToTry = next;
            Util.closeQuietly(realConnection.socket());
    ...
    private final RealConnection findHealthyConnection(int i5, int i6, int i7, int i8, boolean z5, boolean z6) throws IOException {
        while (true) {
            RealConnection realConnectionFindConnection = findConnection(i5, i6, i7, i8, z5);
            boolean z7 = z5;
            int i9 = i8;
            int i10 = i7;
            int i11 = i6;
    ...
    public final boolean sameHostAndPort(HttpUrl httpUrl) {
        ...
        return httpUrl.port() == httpUrlUrl.port() && AbstractC0919e.m2103a(httpUrl.host(), httpUrlUrl.host());
    }
