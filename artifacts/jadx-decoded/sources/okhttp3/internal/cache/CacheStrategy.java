...
public final class CacheStrategy {
    ...
    public static final class Factory {
        ...
        public Factory(long j, Request request, Response response) {
            ...
            if (response != null) {
                ...
                for (int i5 = 0; i5 < size; i5++) {
                    ...
                    if (AbstractC1365k.m3055N(strName, "Date")) {
                        this.servedDate = DatesKt.toHttpDateOrNull(strValue);
                        this.servedDateString = strValue;
                    } else if (AbstractC1365k.m3055N(strName, "Expires")) {
                        this.expires = DatesKt.toHttpDateOrNull(strValue);
                    } else if (AbstractC1365k.m3055N(strName, "Last-Modified")) {
                        this.lastModified = DatesKt.toHttpDateOrNull(strValue);
                        this.lastModifiedString = strValue;
                    } else if (AbstractC1365k.m3055N(strName, "ETag")) {
                        this.etag = strValue;
                    } else if (AbstractC1365k.m3055N(strName, "Age")) {
        ...
        private final long cacheResponseAge() {
            ...
            if (i5 != -1) {
                jMax = Math.max(jMax, TimeUnit.SECONDS.toMillis(i5));
            }
        ...
        private final long computeFreshnessLifetime() {
            ...
            AbstractC0919e.m2105c(response);
