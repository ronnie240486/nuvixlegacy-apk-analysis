...
public final class BasicTrustRootIndex implements TrustRootIndex {
    ...
    public BasicTrustRootIndex(X509Certificate... x509CertificateArr) {
        ...
        for (X509Certificate x509Certificate : x509CertificateArr) {
            ...
            AbstractC0919e.m2107e(subjectX500Principal, "caCert.subjectX500Principal");
    ...
    public boolean equals(Object obj) {
        if (obj != this) {
            return (obj instanceof BasicTrustRootIndex) && AbstractC0919e.m2103a(((BasicTrustRootIndex) obj).subjectToCaCerts, this.subjectToCaCerts);
        }
        return true;
    }
