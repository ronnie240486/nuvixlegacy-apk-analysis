...
public class AndroidSocketAdapter implements SocketAdapter {
        ...
        public final DeferredSocketAdapter.Factory factory(final String str) {
            ...
            return new DeferredSocketAdapter.Factory() { // from class: okhttp3.internal.platform.android.AndroidSocketAdapter$Companion$factory$1
                ...
                public boolean matchesSocket(SSLSocket sSLSocket) {
                    AbstractC0919e.m2108f(sSLSocket, "sslSocket");
                    return AbstractC1365k.m3061T(sSLSocket.getClass().getName(), str + '.', false);
                }
            };
        }
    ...
    public AndroidSocketAdapter(Class<? super SSLSocket> cls) throws NoSuchMethodException {
        ...
        AbstractC0919e.m2107e(declaredMethod, "sslSocketClass.getDeclar…:class.javaPrimitiveType)");
    ...
    public String getSelectedProtocol(SSLSocket sSLSocket) {
        ...
        try {
            ...
            if (bArr != null) {
                return new String(bArr, AbstractC1355a.f5187a);
            }
            return null;
        } catch (IllegalAccessException e6) {
            throw new AssertionError(e6);
            ...
            if ((cause instanceof NullPointerException) && AbstractC0919e.m2103a(((NullPointerException) cause).getMessage(), "ssl == null")) {
                return null;
            }
            throw new AssertionError(e7);
        }
