...
public class OkHttpClient implements Cloneable, Call.Factory, WebSocket.Factory {
    ...
    public static final class Builder {
        ...
        public Builder() {
            ...
            AbstractC0919e.m2107e(socketFactory, "getDefault()");
        ...
        public final Builder m7477addInterceptor(final InterfaceC0820l interfaceC0820l) {
        ...
        public final Builder m7478addNetworkInterceptor(final InterfaceC0820l interfaceC0820l) {
            AbstractC0919e.m2108f(interfaceC0820l, "block");
        ...
        public final Builder addInterceptor(Interceptor interceptor) {
            AbstractC0919e.m2108f(interceptor, "interceptor");
        ...
        public final Builder authenticator(Authenticator authenticator) {
            AbstractC0919e.m2108f(authenticator, "authenticator");
            this.authenticator = authenticator;
            return this;
        }
        ...
        public final Builder certificatePinner(CertificatePinner certificatePinner) {
            AbstractC0919e.m2108f(certificatePinner, "certificatePinner");
        ...
        public final Builder dispatcher(Dispatcher dispatcher) {
            AbstractC0919e.m2108f(dispatcher, "dispatcher");
        ...
        public final Builder eventListenerFactory(EventListener.Factory factory) {
            AbstractC0919e.m2108f(factory, "eventListenerFactory");
        ...
        public final Builder hostnameVerifier(HostnameVerifier hostnameVerifier) {
            AbstractC0919e.m2108f(hostnameVerifier, "hostnameVerifier");
        ...
        public final Builder minWebSocketMessageToCompress(long j) {
            if (j < 0) {
                throw new IllegalArgumentException(AbstractC2567a.m5421e("minWebSocketMessageToCompress must be positive: ", j).toString());
            }
        ...
        public final Builder protocols(List<? extends Protocol> list) {
            ...
            ArrayList arrayListM1063e0 = AbstractC0329k.m1063e0(list);
            Protocol protocol = Protocol.H2_PRIOR_KNOWLEDGE;
            if (!arrayListM1063e0.contains(protocol) && !arrayListM1063e0.contains(Protocol.HTTP_1_1)) {
                throw new IllegalArgumentException(("protocols must contain h2_prior_knowledge or http/1.1: " + arrayListM1063e0).toString());
            }
            if (arrayListM1063e0.contains(protocol) && arrayListM1063e0.size() > 1) {
                throw new IllegalArgumentException(("protocols containing h2_prior_knowledge cannot use other protocols: " + arrayListM1063e0).toString());
            }
            if (arrayListM1063e0.contains(Protocol.HTTP_1_0)) {
                throw new IllegalArgumentException(("protocols must not contain http/1.0: " + arrayListM1063e0).toString());
            }
            if (arrayListM1063e0.contains(null)) {
                throw new IllegalArgumentException("protocols must not contain null");
            }
            arrayListM1063e0.remove(Protocol.SPDY_3);
            if (!arrayListM1063e0.equals(this.protocols)) {
                this.routeDatabase = null;
            }
            List<? extends Protocol> listUnmodifiableList = Collections.unmodifiableList(arrayListM1063e0);
            AbstractC0919e.m2107e(listUnmodifiableList, "unmodifiableList(protocolsCopy)");
            this.protocols = listUnmodifiableList;
            return this;
        }

        public final Builder proxy(Proxy proxy) {
            if (!AbstractC0919e.m2103a(proxy, this.proxy)) {
                this.routeDatabase = null;
            }
            this.proxy = proxy;
            return this;
        ...
        public final void setAuthenticator$okhttp(Authenticator authenticator) {
            AbstractC0919e.m2108f(authenticator, "<set-?>");
            this.authenticator = authenticator;
        }
        ...
        public final void setCertificatePinner$okhttp(CertificatePinner certificatePinner) {
            AbstractC0919e.m2108f(certificatePinner, "<set-?>");
            this.certificatePinner = certificatePinner;
        }
        ...
        public final void setConnectionPool$okhttp(ConnectionPool connectionPool) {
            AbstractC0919e.m2108f(connectionPool, "<set-?>");
            this.connectionPool = connectionPool;
        }

        public final void setConnectionSpecs$okhttp(List<ConnectionSpec> list) {
            AbstractC0919e.m2108f(list, "<set-?>");
            this.connectionSpecs = list;
        }

        public final void setCookieJar$okhttp(CookieJar cookieJar) {
            AbstractC0919e.m2108f(cookieJar, "<set-?>");
            this.cookieJar = cookieJar;
        }

        public final void setDispatcher$okhttp(Dispatcher dispatcher) {
            AbstractC0919e.m2108f(dispatcher, "<set-?>");
            this.dispatcher = dispatcher;
        }

        public final void setDns$okhttp(Dns dns) {
            AbstractC0919e.m2108f(dns, "<set-?>");
            this.dns = dns;
        }

        public final void setEventListenerFactory$okhttp(EventListener.Factory factory) {
            AbstractC0919e.m2108f(factory, "<set-?>");
            this.eventListenerFactory = factory;
        }
        ...
        public final void setHostnameVerifier$okhttp(HostnameVerifier hostnameVerifier) {
            AbstractC0919e.m2108f(hostnameVerifier, "<set-?>");
            this.hostnameVerifier = hostnameVerifier;
        }
        ...
        public final void setSocketFactory$okhttp(SocketFactory socketFactory) {
            AbstractC0919e.m2108f(socketFactory, "<set-?>");
            this.socketFactory = socketFactory;
        }
        ...
        public final Builder sslSocketFactory(SSLSocketFactory sSLSocketFactory) throws IllegalAccessException {
            ...
            AbstractC0919e.m2105c(x509TrustManager);
        ...
        public final Builder callTimeout(Duration duration) {
            AbstractC0919e.m2108f(duration, "duration");
        ...
        public Builder(OkHttpClient okHttpClient) {
            this();
            AbstractC0919e.m2108f(okHttpClient, "okHttpClient");
            this.dispatcher = okHttpClient.dispatcher();
            this.connectionPool = okHttpClient.connectionPool();
            AbstractC0335q.m1068V(this.interceptors, okHttpClient.interceptors());
            AbstractC0335q.m1068V(this.networkInterceptors, okHttpClient.networkInterceptors());
            ...
            while (it.hasNext()) {
                if (((ConnectionSpec) it.next()).isTls()) {
                    if (builder.getSslSocketFactoryOrNull$okhttp() != null) {
                        ...
                        AbstractC0919e.m2105c(x509TrustManagerOrNull$okhttp);
                        ...
                        Platform platform = companion.get();
                        AbstractC0919e.m2105c(x509TrustManagerPlatformTrustManager);
                        ...
                        AbstractC0919e.m2105c(certificateChainCleaner);
    ...
    private final void verifyClientState() {
        ...
        AbstractC0919e.m2106d(list, "null cannot be cast to non-null type kotlin.collections.List<okhttp3.Interceptor?>");
        if (list.contains(null)) {
            throw new IllegalStateException(("Null interceptor: " + this.interceptors).toString());
        }
        List<Interceptor> list2 = this.networkInterceptors;
        AbstractC0919e.m2106d(list2, "null cannot be cast to non-null type kotlin.collections.List<okhttp3.Interceptor?>");
