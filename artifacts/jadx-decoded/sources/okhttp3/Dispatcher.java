...
public final class Dispatcher {
    ...
    private final RealCall.AsyncCall findExistingCallWithHost(String str) {
        for (RealCall.AsyncCall asyncCall : this.runningAsyncCalls) {
            if (AbstractC0919e.m2103a(asyncCall.getHost(), str)) {
                return asyncCall;
            }
        }
        for (RealCall.AsyncCall asyncCall2 : this.readyAsyncCalls) {
            if (AbstractC0919e.m2103a(asyncCall2.getHost(), str)) {
                return asyncCall2;
            }
        }
        return null;
    ...
    private final boolean promoteAndExecute() {
        ...
        synchronized (this) {
            try {
                ...
                AbstractC0919e.m2107e(it, "readyAsyncCalls.iterator()");
                while (it.hasNext()) {
    ...
    public final ExecutorService m7406deprecated_executorService() {
    ...
    public final void enqueue$okhttp(RealCall.AsyncCall asyncCall) {
        ...
        AbstractC0919e.m2108f(asyncCall, "call");
        synchronized (this) {
    ...
    public final synchronized ExecutorService executorService() {
        ...
        try {
            ...
            AbstractC0919e.m2105c(executorService);
        } catch (Throwable th) {
            throw th;
        }
        return executorService;
    ...
    public final synchronized List<Call> queuedCalls() {
        ...
        try {
            ...
            ArrayList arrayList = new ArrayList(AbstractC0331m.m1067U(arrayDeque));
            Iterator<T> it = arrayDeque.iterator();
            while (it.hasNext()) {
                arrayList.add(((RealCall.AsyncCall) it.next()).getCall());
            }
            listUnmodifiableList = Collections.unmodifiableList(arrayList);
            AbstractC0919e.m2107e(listUnmodifiableList, "unmodifiableList(readyAsyncCalls.map { it.call })");
        } catch (Throwable th) {
            throw th;
        }
    ...
    public final synchronized List<Call> runningCalls() {
        ...
        try {
            ...
            ArrayList arrayList = new ArrayList(AbstractC0331m.m1067U(arrayDeque2));
            Iterator<T> it = arrayDeque2.iterator();
            while (it.hasNext()) {
                arrayList.add(((RealCall.AsyncCall) it.next()).getCall());
            }
            listUnmodifiableList = Collections.unmodifiableList(AbstractC0329k.m1060b0(arrayDeque, arrayList));
            AbstractC0919e.m2107e(listUnmodifiableList, "unmodifiableList(running…yncCalls.map { it.call })");
        } catch (Throwable th) {
            throw th;
        }
        return listUnmodifiableList;
    ...
    public final void setMaxRequests(int i5) {
        if (i5 < 1) {
            throw new IllegalArgumentException(AbstractC2567a.m5420d(i5, "max < 1: ").toString());
        }
        synchronized (this) {
            this.maxRequests = i5;
        }
    ...
    public Dispatcher(ExecutorService executorService) {
        this();
        AbstractC0919e.m2108f(executorService, "executorService");
