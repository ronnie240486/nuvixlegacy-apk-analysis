...
public final class ConnectionSpec {
    ...
    private final ConnectionSpec supportedSpec(SSLSocket sSLSocket, boolean z5) {
        ...
        if (this.cipherSuitesAsString != null) {
            ...
            AbstractC0919e.m2107e(enabledCipherSuites2, "sslSocket.enabledCipherSuites");
        ...
        if (this.tlsVersionsAsString != null) {
            ...
            AbstractC0919e.m2107e(enabledProtocols2, "sslSocket.enabledProtocols");
            enabledProtocols = Util.intersect(enabledProtocols2, this.tlsVersionsAsString, C0392a.f1844q);
        } else {
            enabledProtocols = sSLSocket.getEnabledProtocols();
        }
        String[] supportedCipherSuites = sSLSocket.getSupportedCipherSuites();
        AbstractC0919e.m2107e(supportedCipherSuites, "supportedCipherSuites");
        int iIndexOf = Util.indexOf(supportedCipherSuites, "TLS_FALLBACK_SCSV", CipherSuite.Companion.getORDER_BY_NAME$okhttp());
        if (z5 && iIndexOf != -1) {
            AbstractC0919e.m2107e(enabledCipherSuites, "cipherSuitesIntersection");
            String str = supportedCipherSuites[iIndexOf];
            AbstractC0919e.m2107e(str, "supportedCipherSuites[indexOfFallbackScsv]");
        ...
        AbstractC0919e.m2107e(enabledProtocols, "tlsVersionsIntersection");
    ...
    public final List<CipherSuite> m7394deprecated_cipherSuites() {
        return cipherSuites();
    }

    /* JADX INFO: renamed from: -deprecated_supportsTlsExtensions, reason: not valid java name */
    public final boolean m7395deprecated_supportsTlsExtensions() {
        return this.supportsTlsExtensions;
    }

    /* JADX INFO: renamed from: -deprecated_tlsVersions, reason: not valid java name */
    public final List<TlsVersion> m7396deprecated_tlsVersions() {
        return tlsVersions();
    }
    ...
    public final List<CipherSuite> cipherSuites() {
        ...
        return AbstractC0329k.m1062d0(arrayList);
    }
    ...
    public final boolean isCompatible(SSLSocket sSLSocket) {
        AbstractC0919e.m2108f(sSLSocket, "socket");
        if (!this.isTls) {
            return false;
        }
        String[] strArr = this.tlsVersionsAsString;
        if (strArr != null && !Util.hasIntersection(strArr, sSLSocket.getEnabledProtocols(), C0392a.f1844q)) {
            return false;
        }
    ...
    public static final class Builder {
        ...
        public final Builder cipherSuites(CipherSuite... cipherSuiteArr) {
            AbstractC0919e.m2108f(cipherSuiteArr, "cipherSuites");
            if (!this.tls) {
                throw new IllegalArgumentException("no cipher suites for cleartext connections");
            }
        ...
        public final Builder tlsVersions(TlsVersion... tlsVersionArr) {
            AbstractC0919e.m2108f(tlsVersionArr, "tlsVersions");
            if (!this.tls) {
                throw new IllegalArgumentException("no TLS versions for cleartext connections");
            }
        ...
        public final Builder cipherSuites(String... strArr) {
            AbstractC0919e.m2108f(strArr, "cipherSuites");
            if (this.tls) {
                if (!(strArr.length == 0)) {
        ...
        public final Builder tlsVersions(String... strArr) {
            AbstractC0919e.m2108f(strArr, "tlsVersions");
            if (this.tls) {
                if (!(strArr.length == 0)) {
