...
public class C2886E extends RadioButton implements InterfaceC1175k, InterfaceC1176l {

    /* JADX INFO: renamed from: p */
    public final C2980t f11772p;

    /* JADX INFO: renamed from: q */
    public final C2972p f11773q;

    /* JADX INFO: renamed from: r */
    public final C2925Y f11774r;

    /* JADX INFO: renamed from: s */
    public C2988x f11775s;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C2886E(Context context, AttributeSet attributeSet) {
        super(context, attributeSet, R.attr.radioButtonStyle);
        AbstractC2916T0.m6008a(context);
        AbstractC2914S0.m6004a(getContext(), this);
        C2980t c2980t = new C2980t(this);
        this.f11772p = c2980t;
        c2980t.m6086c(attributeSet, R.attr.radioButtonStyle);
        C2972p c2972p = new C2972p(this);
        this.f11773q = c2972p;
        c2972p.m6070d(attributeSet, R.attr.radioButtonStyle);
        C2925Y c2925y = new C2925Y(this);
        this.f11774r = c2925y;
        c2925y.m6023f(attributeSet, R.attr.radioButtonStyle);
        getEmojiTextViewHelper().m6102a(attributeSet, R.attr.radioButtonStyle);
    }

    private C2988x getEmojiTextViewHelper() {
        if (this.f11775s == null) {
            this.f11775s = new C2988x(this);
        }
        return this.f11775s;
    }
    ...
    public final void drawableStateChanged() {
        ...
        C2972p c2972p = this.f11773q;
        if (c2972p != null) {
            c2972p.m6067a();
        }
        C2925Y c2925y = this.f11774r;
        if (c2925y != null) {
            c2925y.m6020b();
        }
    }
    ...
    public ColorStateList getSupportCompoundDrawablesTintList() {
        return this.f11774r.m6021d();
    }

    public PorterDuff.Mode getSupportCompoundDrawablesTintMode() {
        return this.f11774r.m6022e();
    }
