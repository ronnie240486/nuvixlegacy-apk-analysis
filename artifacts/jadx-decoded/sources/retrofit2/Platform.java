...
class Platform {
    ...
    public Platform(boolean z5) {
        ...
        if (z5) {
            try {
                declaredConstructor = AbstractC0054G.m412l().getDeclaredConstructor(Class.class, Integer.TYPE);
    ...
    public Object invokeDefaultMethod(Method method, Class<?> cls, Object obj, Object... objArr) {
        ...
        return (constructor != null ? AbstractC0054G.m418r(constructor.newInstance(cls, -1)) : MethodHandles.lookup()).unreflectSpecial(method, cls).bindTo(obj).invokeWithArguments(objArr);
    }
