...
final class DefaultCallAdapterFactory extends CallAdapter.Factory {
    ...
    public static final class ExecutorCallbackCall<T> implements Call<T> {
        ...
        /* JADX INFO: compiled from: r8-map-id-3b0fe1fe3be310c6d55756f0e4e73dab92065bed65670a23f41d484dc89ae294 */
        public class C32011 implements Callback<T> {
            final /* synthetic */ Callback val$callback;

            public C32011(Callback callback) {
            ...
            public void onFailure(Call<T> call, Throwable th) {
                ExecutorCallbackCall.this.callbackExecutor.execute(new RunnableC3212a(this, this.val$callback, th, 1));
            }

            @Override // retrofit2.Callback
            public void onResponse(Call<T> call, Response<T> response) {
                ExecutorCallbackCall.this.callbackExecutor.execute(new RunnableC3212a(this, this.val$callback, response, 0));
            }
        }
        ...
        public void enqueue(Callback<T> callback) {
            ...
            this.delegate.enqueue(new C32011(callback));
        }
