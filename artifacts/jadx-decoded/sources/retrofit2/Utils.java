...
final class Utils {
    ...
    public static final class GenericArrayTypeImpl implements GenericArrayType {
        ...
        public String toString() {
            return AbstractC2567a.m5423g(new StringBuilder(), Utils.typeToString(this.componentType), HttpUrl.PATH_SEGMENT_ENCODE_SET_URI);
        }
    }
    ...
    public static ResponseBody buffer(ResponseBody responseBody) {
        ...
        responseBody.source().mo5055G(c2385l);
        return ResponseBody.create(responseBody.contentType(), responseBody.contentLength(), c2385l);
    }
    ...
    public static Type getParameterUpperBound(int i5, ParameterizedType parameterizedType) {
        ...
        StringBuilder sbM74l = AbstractC0005f.m74l("Index ", i5, " not in range [0,");
        sbM74l.append(actualTypeArguments.length);
        sbM74l.append(") for ");
        sbM74l.append(parameterizedType);
    ...
    public static RuntimeException parameterError(Method method, Throwable th, int i5, String str, Object... objArr) {
        StringBuilder sbM7073a = AbstractC3499e.m7073a(str, " (parameter #");
        sbM7073a.append(i5 + 1);
        sbM7073a.append(")");
        return methodError(method, th, sbM7073a.toString(), objArr);
    }
    ...
    public static Type resolve(Type type, Class<?> cls, Type type2) {
        ...
        if (type4 instanceof ParameterizedType) {
            ...
            for (int i5 = 0; i5 < length; i5++) {
                Type typeResolve4 = resolve(type, cls, actualTypeArguments[i5]);
                if (typeResolve4 != actualTypeArguments[i5]) {
                    if (!z5) {
    ...
    public static RuntimeException methodError(Method method, @Nullable Throwable th, String str, Object... objArr) {
        StringBuilder sbM7073a = AbstractC3499e.m7073a(String.format(str, objArr), "\n    for method ");
        sbM7073a.append(method.getDeclaringClass().getSimpleName());
        sbM7073a.append(".");
        sbM7073a.append(method.getName());
        return new IllegalArgumentException(sbM7073a.toString(), th);
    }
    ...
    public static RuntimeException parameterError(Method method, int i5, String str, Object... objArr) {
        ...
        sbM7073a.append(i5 + 1);
        sbM7073a.append(")");
        return methodError(method, sbM7073a.toString(), objArr);
    }
}
