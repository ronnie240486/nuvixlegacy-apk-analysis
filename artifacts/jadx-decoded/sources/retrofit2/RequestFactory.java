...
final class RequestFactory {
    ...
    public static final class Builder {
            ...
            for (String str : strArr) {
                ...
                if ("Content-Type".equalsIgnoreCase(strSubstring)) {
                    try {
                        ...
                        throw Utils.methodError(this.method, e6, "Malformed content type: %s", strTrim);
                    }
                } else {
        ...
        @Nullable
        private ParameterHandler<?> parseParameter(int i5, Type type, @Nullable Annotation[] annotationArr, boolean z5) {
            ParameterHandler<?> parameterHandler;
            if (annotationArr != null) {
                parameterHandler = null;
                for (Annotation annotation : annotationArr) {
                    ParameterHandler<?> parameterAnnotation = parseParameterAnnotation(i5, type, annotationArr, annotation);
            ...
            if (z5) {
                try {
                    if (Utils.getRawType(type) == InterfaceC0463b.class) {
        ...
        private ParameterHandler<?> parseParameterAnnotation(int i5, Type type, Annotation[] annotationArr, Annotation annotation) {
            ...
            if (annotation instanceof Path) {
                ...
                validatePathName(i5, strValue);
                return new ParameterHandler.Path(this.method, i5, strValue, this.retrofit.stringConverter(type, annotationArr), path.encoded());
            }
            ...
            if (annotation instanceof FieldMap) {
                ...
                if (String.class == parameterUpperBound3) {
                    ...
                    this.gotField = true;
                    return new ParameterHandler.FieldMap(this.method, i5, converterStringConverter, ((FieldMap) annotation).encoded());
                }
            ...
            if (annotation instanceof Part) {
                ...
                Headers headersM6199of = Headers.m6199of("Content-Disposition", AbstractC0005f.m73k("form-data; name=\"", strValue5, "\""), "Content-Transfer-Encoding", part.encoding());
                if (!Iterable.class.isAssignableFrom(rawType8)) {
                    if (!rawType8.isArray()) {
                        if (MultipartBody.Part.class.isAssignableFrom(rawType8)) {
                        ...
                        return new ParameterHandler.Part(this.method, i5, headersM6199of, this.retrofit.requestBodyConverter(type, annotationArr, this.methodAnnotations));
                    }
                    ...
                    return new ParameterHandler.Part(this.method, i5, headersM6199of, this.retrofit.requestBodyConverter(clsBoxIfPrimitive, annotationArr, this.methodAnnotations)).array();
                }
                if (type instanceof ParameterizedType) {
                    ...
                    return new ParameterHandler.Part(this.method, i5, headersM6199of, this.retrofit.requestBodyConverter(parameterUpperBound4, annotationArr, this.methodAnnotations)).iterable();
                }
                throw Utils.parameterError(this.method, i5, rawType8.getSimpleName() + " must include generic type (e.g., " + rawType8.getSimpleName() + "<String>)", new Object[0]);
            }
            ...
            if (annotation instanceof Body) {
                ...
                try {
                    ...
                    this.gotBody = true;
                    return new ParameterHandler.Body(this.method, i5, converterRequestBodyConverter);
                } catch (RuntimeException e6) {
                    throw Utils.parameterError(this.method, e6, i5, "Unable to create @Body converter for %s", type);
                }
            }
        ...
        public RequestFactory build() {
            ...
            while (true) {
                ...
                parameterHandlerArr[i6] = parseParameter(i6, type, annotationArr, z5);
                i6++;
            }
    ...
    public Request create(Object[] objArr) {
        ...
        if (length != parameterHandlerArr.length) {
            StringBuilder sbM74l = AbstractC0005f.m74l("Argument count (", length, ") doesn't match expected count (");
            sbM74l.append(parameterHandlerArr.length);
            sbM74l.append(")");
