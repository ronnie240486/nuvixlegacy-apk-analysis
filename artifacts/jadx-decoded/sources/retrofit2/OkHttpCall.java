...
final class OkHttpCall<T> implements Call<T> {
    ...
    public static final class ExceptionCatchingResponseBody extends ResponseBody {
        ...
        private final InterfaceC2387n delegateSource;
        ...
        public ExceptionCatchingResponseBody(ResponseBody responseBody) {
            ...
            this.delegateSource = AbstractC2375b.m5039c(new AbstractC2391r(responseBody.source()) { // from class: retrofit2.OkHttpCall.ExceptionCatchingResponseBody.1
                @Override // p192f5.AbstractC2391r, p192f5.InterfaceC2370F
                public long read(C2385l c2385l, long j) throws IOException {
                    try {
                        return super.read(c2385l, j);
    ...
    @Override // retrofit2.Call
    public synchronized C2373I timeout() {
        try {
        } catch (IOException e6) {
