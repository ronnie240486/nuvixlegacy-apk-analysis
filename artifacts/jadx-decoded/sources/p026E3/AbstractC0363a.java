...
public abstract class AbstractC0363a {
    ...
    public static String m1146b(byte[] bArr, int i5, int i6) {
        ...
        int i10 = 0;
        while (i7 < i5 + i6) {
            char cCharAt = f1730g[i9].charAt(bArr[i7]);
            switch (cCharAt) {
                case 65520:
                case 65521:
                case 65522:
                ...
                default:
                    ...
                    break;
                case 65531:
                    int i11 = (bArr[i7 + 1] << 24) + (bArr[i7 + 2] << 18) + (bArr[i7 + 3] << 12) + (bArr[i7 + 4] << 6);
                    i7 += 5;
