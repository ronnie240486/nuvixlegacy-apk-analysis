...
public final class SeriesCategoryDao_Impl implements SeriesCategoryDao {
    ...
    public SeriesCategoryDao_Impl(AbstractC1814o abstractC1814o) {
        this.__db = abstractC1814o;
        this.__insertionAdapterOfItemCat = new AbstractC1804e(abstractC1814o) { // from class: com.legacy.prime.BancoSql.series.SeriesCategoryDao_Impl.1
        ...
        this.__preparedStmtOfLimpar = new AbstractC1819t(abstractC1814o) { // from class: com.legacy.prime.BancoSql.series.SeriesCategoryDao_Impl.2
            @Override // androidx.room.AbstractC1819t
            public String createQuery() {
    ...
    public List<C2556a> getCategoriasAnimes() {
        C1817r c1817rM4247S = C1817r.m4247S(0, "SELECT * FROM cat WHERE LOWER(name) LIKE '%anime%'");
    ...
    @Override // com.legacy.prime.BancoSql.series.SeriesCategoryDao
    public List<C2556a> getTodasCategorias() {
