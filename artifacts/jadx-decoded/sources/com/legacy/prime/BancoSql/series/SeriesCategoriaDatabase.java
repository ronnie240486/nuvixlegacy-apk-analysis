...
public abstract class SeriesCategoriaDatabase extends AbstractC1814o {
    ...
    public static SeriesCategoriaDatabase getInstance(Context context) {
        if (INSTANCE == null) {
            synchronized (SeriesCategoriaDatabase.class) {
                try {
                    if (INSTANCE == null) {
                        C1812m c1812mM4411h = AbstractC1970e.m4411h(context.getApplicationContext(), SeriesCategoriaDatabase.class, "series_category.db");
                        c1812mM4411h.m4244b();
                        INSTANCE = (SeriesCategoriaDatabase) c1812mM4411h.m4243a();
                    }
                } catch (Throwable th) {
                    throw th;
                }
