...
public abstract class LiveDatabase extends AbstractC1814o {
    ...
    public static LiveDatabase getInstance(Context context) {
        if (INSTANCE == null) {
            synchronized (LiveDatabase.class) {
                try {
                    if (INSTANCE == null) {
                        C1812m c1812mM4411h = AbstractC1970e.m4411h(context.getApplicationContext(), LiveDatabase.class, "live_db");
                        c1812mM4411h.m4244b();
                        INSTANCE = (LiveDatabase) c1812mM4411h.m4243a();
                    }
                } catch (Throwable th) {
                    throw th;
                }
