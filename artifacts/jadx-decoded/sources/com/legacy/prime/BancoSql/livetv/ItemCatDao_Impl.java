...
public final class ItemCatDao_Impl implements ItemCatDao {
    ...
    public ItemCatDao_Impl(AbstractC1814o abstractC1814o) {
        this.__db = abstractC1814o;
        this.__insertionAdapterOfItemCat = new AbstractC1804e(abstractC1814o) { // from class: com.legacy.prime.BancoSql.livetv.ItemCatDao_Impl.1
        ...
        this.__preparedStmtOfLimpar = new AbstractC1819t(abstractC1814o) { // from class: com.legacy.prime.BancoSql.livetv.ItemCatDao_Impl.2
            @Override // androidx.room.AbstractC1819t
            public String createQuery() {
    ...
    @Override // com.legacy.prime.BancoSql.livetv.ItemCatDao
    public String getAdultCategoryId() {
        C1817r c1817rM4247S = C1817r.m4247S(0, "SELECT id FROM cat WHERE LOWER(name) LIKE '%adul%'    OR LOWER(name) LIKE '%+18%' LIMIT 1");
        this.__db.assertNotSuspendingTransaction();
        Cursor cursorM4398J = AbstractC1970e.m4398J(this.__db, c1817rM4247S);
        try {
            String string = null;
            if (cursorM4398J.moveToFirst() && !cursorM4398J.isNull(0)) {
                string = cursorM4398J.getString(0);
            }
            return string;
        } finally {
            cursorM4398J.close();
