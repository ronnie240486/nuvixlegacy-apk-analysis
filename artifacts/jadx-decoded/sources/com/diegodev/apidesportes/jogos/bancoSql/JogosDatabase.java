...
public abstract class JogosDatabase extends AbstractC1814o {
    ...
    public static JogosDatabase getInstance(Context context) {
        if (INSTANCE == null) {
            synchronized (JogosDatabase.class) {
                try {
                    if (INSTANCE == null) {
                        C1812m c1812mM4411h = AbstractC1970e.m4411h(context.getApplicationContext(), JogosDatabase.class, "jogos.db");
                        c1812mM4411h.m4244b();
                        INSTANCE = (JogosDatabase) c1812mM4411h.m4243a();
                    }
                } catch (Throwable th) {
                    throw th;
                }
