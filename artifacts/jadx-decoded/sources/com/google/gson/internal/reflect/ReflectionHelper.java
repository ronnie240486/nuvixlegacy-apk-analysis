...
public class ReflectionHelper {
    ...
    public static class RecordSupportedHelper extends RecordHelper {
        ...
        public Method getAccessor(Class<?> cls, Field field) {
            try {
                ...
                throw ReflectionHelper.createExceptionForRecordReflectionException(e6);
            }
        }
    ...
    public static String getAccessibleObjectDescription(AccessibleObject accessibleObject, boolean z5) {
        String str;
    ...
    public static void makeAccessible(AccessibleObject accessibleObject) {
        try {
            ...
            StringBuilder sbM75m = AbstractC0005f.m75m("Failed making ", getAccessibleObjectDescription(accessibleObject, false), " accessible; either increase its visibility or write a custom TypeAdapter for its declaring type.");
            sbM75m.append(getInaccessibleTroubleshootingSuffix(e6));
            throw new JsonIOException(sbM75m.toString(), e6);
        }
    }
    ...
    public static String tryMakeAccessible(Constructor<?> constructor) {
        try {
            ...
            return "Failed making constructor '" + constructorToString(constructor) + "' accessible; either increase its visibility or write a custom InstanceCreator or TypeAdapter for its declaring type: " + e6.getMessage() + getInaccessibleTroubleshootingSuffix(e6);
        }
    }
}
