...
public final class JsonAdapterAnnotationTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public TypeAdapter<?> getTypeAdapter(ConstructorConstructor constructorConstructor, Gson gson, TypeToken<?> typeToken, JsonAdapter jsonAdapter, boolean z5) {
        ...
        if (objCreateAdapter instanceof TypeAdapter) {
            ...
            boolean z6 = objCreateAdapter instanceof JsonSerializer;
            if (!z6 && !(objCreateAdapter instanceof JsonDeserializer)) {
            ...
            TreeTypeAdapter treeTypeAdapter = new TreeTypeAdapter(z6 ? (JsonSerializer) objCreateAdapter : null, objCreateAdapter instanceof JsonDeserializer ? (JsonDeserializer) objCreateAdapter : null, gson, typeToken, z5 ? TREE_TYPE_CLASS_DUMMY_FACTORY : TREE_TYPE_FIELD_DUMMY_FACTORY, zNullSafe);
            zNullSafe = false;
