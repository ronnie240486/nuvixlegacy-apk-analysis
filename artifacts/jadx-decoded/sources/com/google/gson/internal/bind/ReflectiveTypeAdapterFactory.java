...
public final class ReflectiveTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public static abstract class Adapter<T, A> extends TypeAdapter<T> {
        ...
        public abstract void readField(A a3, JsonReader jsonReader, BoundField boundField);
    ...
    public static final class RecordAdapter<T> extends Adapter<T, Object[]> {
        ...
        public void readField(Object[] objArr, JsonReader jsonReader, BoundField boundField) {
            ...
            throw new IllegalStateException(AbstractC2567a.m5423g(sb, boundField.fieldName, "', unable to determine which argument in the constructor the field corresponds to. This is unexpected behavior, as we expect the RecordComponents to have the same names as the fields in the Java class, and that the order of the RecordComponents is the same as the order of the canonical constructor parameters."));
        }
    }
    ...
    public static <M extends AccessibleObject & Member> void checkAccessible(Object obj, M m5) {
        ...
        if (!ReflectionAccessFilterHelper.canAccess(m5, obj)) {
            throw new JsonIOException(AbstractC2567a.m5422f(ReflectionHelper.getAccessibleObjectDescription(m5, true), " is not accessible and ReflectionAccessFilter does not permit making it accessible. Register a TypeAdapter for the declaring type, adjust the access filter or increase the visibility of the element and its declaring type."));
        }
    }
        ...
        return new BoundField(str, field) { // from class: com.google.gson.internal.bind.ReflectiveTypeAdapterFactory.2
            ...
            public void readIntoField(JsonReader jsonReader, Object obj) throws IllegalAccessException {
                ...
                if (z6) {
                    ...
                    throw new JsonIOException(AbstractC0005f.m71i("Cannot set value of 'static final' ", ReflectionHelper.getAccessibleObjectDescription(this.field, false)));
                }
            ...
            public void write(JsonWriter jsonWriter, Object obj) throws IllegalAccessException {
                ...
                if (method3 != null) {
                    try {
                        ...
                        throw new JsonIOException(AbstractC0005f.m73k("Accessor ", ReflectionHelper.getAccessibleObjectDescription(method, false), " threw exception"), e6.getCause());
                    }
                } else {
                ...
                if (zIncludeField || zIncludeField2) {
                    ...
                    if (!z6) {
                        ...
                        if (accessor.getAnnotation(SerializedName.class) != null && field.getAnnotation(SerializedName.class) == null) {
                            throw new JsonIOException(AbstractC0005f.m73k("@SerializedName on ", ReflectionHelper.getAccessibleObjectDescription(accessor, z11), " is not supported"));
                        }
                        z7 = zIncludeField2;
                    }
