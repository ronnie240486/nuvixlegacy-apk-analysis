        ...
        public Map<K, V> read(JsonReader jsonReader) throws IOException {
            ...
            if (jsonTokenPeek != JsonToken.BEGIN_ARRAY) {
                ...
                while (jsonReader.hasNext()) {
                    ...
                    K k5 = this.keyTypeAdapter.read(jsonReader);
                    if (mapConstruct.put(k5, this.valueTypeAdapter.read(jsonReader)) != null) {
                        throw new JsonSyntaxException("duplicate key: " + k5);
                    }
                }
            ...
            while (jsonReader.hasNext()) {
                ...
                if (mapConstruct.put(k6, this.valueTypeAdapter.read(jsonReader)) != null) {
                    throw new JsonSyntaxException("duplicate key: " + k6);
                }
                jsonReader.endArray();
            }
            jsonReader.endArray();
